...
public class QustomDialogBuilder extends AlertDialog.Builder {
     ...
     *
     * @param res for passing "#ffffff"
     */
    public QustomDialogBuilder setDividerColorResource(int res) {
        mDivider.setBackgroundColor(getContext().getResources().getColor(res));
        return this;
    }
    ...
    public QustomDialogBuilder setTitleColorResource(int res) {
        mTitle.setTextColor(getContext().getResources().getColor(res));
        return this;
    }
    ...
    public AlertDialog show() {
        ...
        b.setBackgroundResource(R.drawable.selector_qustom_dialog);
        return dialog;
    }
